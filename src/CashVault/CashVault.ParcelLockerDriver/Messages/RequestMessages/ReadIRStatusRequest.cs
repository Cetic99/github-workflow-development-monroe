...
/// <summary>
/// Request to read the IR sensor status of cabinet(s)
/// Command format: 0x80 [Address] [CabinetNo] 0x22 [Checksum]
/// If CabinetNo is 0x00, reads all cabinets in the group
/// If CabinetNo is 0x01-0x18, reads a single cabinet
/// </summary>
public class ReadIRStatusRequest : BaseRequestMessage
{
    private const byte FRAME_HEADER = 0x80;
    private const byte COMMAND = 0x22;
    ...
    public ReadIRStatusRequest(byte boardAddress, byte cabinetNumber) : base()
    {
