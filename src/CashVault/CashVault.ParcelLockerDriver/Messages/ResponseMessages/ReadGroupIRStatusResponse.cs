...
/// <summary>
/// Response to ReadIRStatusRequest for a group of cabinets
/// Response format: 0x80 [Address] [Ch25-32] [Ch17-24] [Ch9-16] [Ch1-8] 0x22 [Checksum]
/// Each byte represents 8 cabinets, where bit=1 means unoccupied and bit=0 means occupied
/// </summary>
public class ReadGroupIRStatusResponse : BaseResponseMessage
{
    private const byte FRAME_HEADER = 0x80;
    private const byte END_COMMAND = 0x22;
    ...
    public ReadGroupIRStatusResponse(byte[] data) : base(data)
    {
