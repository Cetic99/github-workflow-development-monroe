...
import { useFailLogs } from '@domain/records/queries'
...
import EventFailDetails from '../fail-event-details'
...
const EventFailLogs = () => {
  ...
  const { data, isSuccess, isLoading } = useFailLogs({
  ...
  const columns = [
    ...
    { id: 3, width: null, value: `${t('Type')} / ${t('Device Type')}`, accessor: 'deviceType' },
  ...
  return (
    <Container>
      ...
      <EventFailDetails data={details} ref={modalDetailsRef} onClose={onCloseModalDetails} />
