...
import {
  ...
  setAuthFailedStatus,
  useGlobalActions
} from '@src/app/domain/global/stores'
import { CommandType } from '@src/app/domain/operator/commands'
import { Mediator } from '@src/app/infrastructure/command-system'
import { useAuthenticate } from '@src/app/domain/global/commands'
...
const AdminLoginScreen = () => {
  ...
  const loginCommand = useAuthenticate(() => navigate('/parcel-locker/shipments'))
