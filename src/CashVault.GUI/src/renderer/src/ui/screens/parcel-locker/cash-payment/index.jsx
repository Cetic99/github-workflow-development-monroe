...
import ImageCashPayment from '@icons/ImageCashPayment'
    ...
    <ScreenContainerBottom>
      ...
      >
        <div className="content">
          <ScreenHeadingV2
            top={() => <ImageCashPayment />}
            middle={t('Cash payment')}
            bottom={() => (
              <>
                {t('To complete the payment, please insert the required amount in the slot below.')}
              </>
            )}
          />
